...
public class DataGui extends JFrame {
    ...
    public DataGui() {
        setTitle("Basketball Arena Data Analyzer");
        setSize(500, 400);
    ...
    private void analyzeByTeam(){
        ...
        resultsArea.setText("Arenas by Team " + inputField.getText() + ": " + string(arenas) + "\n");
    }
    private void analyzeByLocation(){
        String[] arenas = DataAnalyzer.arenasByLocation((inputField.getText()),file);

        resultsArea.setText("Arenas by Location " + inputField.getText() + ": " + string(arenas) + "\n");
    }
    private void analyzeByCapacity(){
        String[] arenas = DataAnalyzer.arenasByCapacity((inputField.getText()),file);

        resultsArea.setText("Arenas by Capacity " + inputField.getText() + ": " + string(arenas) + "\n");
    }
    ...
    private void getLargestArena(){
        ...
        resultsArea.setText("The Largest Arena: " + arena);
    }

    private void getMinChampionships(){
        String[] arenas = DataAnalyzer.minChampionships(file);
        resultsArea.setText("Teams with the smallest number of championships: " + string(arenas));
    }
